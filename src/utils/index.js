...
export const create400 = (res, message, err) =>
  createHTTPResponse(400, res, message, err);

export const create404 = (res, message, err) =>
  createHTTPResponse(404, res, message, err);

export const create500 = (res, message, err) =>
  createHTTPResponse(500, res, message, err);
...
export function createHTTPResponse(status, res, message, err) {
  ...
  if (detectDebug() && err) console.error((body.error = err));
